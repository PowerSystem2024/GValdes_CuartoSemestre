...
/* === Mercado Pago (PUBLIC KEY DEL LADO CLIENTE) === */
const mercadopago = new MercadoPago("APP_USR-de96f634-dd37-40db-8614-62eeb4e2ca13", {
  locale: "es-AR",
});
...
const displayCart = () => {
  ...
  if (cart.length > 0) {
    ...
    // modal footer (solo si hay productos)
    ...
    checkoutButton.addEventListener("click", function () {
      ...
      const orderData = {
        ...
        price: Number(total), // <-- aseguro número
      };
    ...
    function createCheckoutButton(preferenceId) {
      ...
      const renderComponent = async (bricksBuilder) => {
        try {
          // limpio el contenedor por si se reabre el modal
