...
cover.addEventListener("click", function () {
    ...
    if (isOpen) {
        ...
        this.classList.remove("pass-through"); // vuelve a bloquear clics
    } else {
        this.classList.add("opened");
        this.classList.add("pass-through");    // deja pasar clics al botón
    }
});
...
btn.addEventListener("click", function () {
    if (!cover.classList.contains("opened")) return; // <--- bloqueo
    this.classList.add("pushed");
    alarm.currentTime = 0;
    alarm.play();
    setTimeout(function () {
...
reload.addEventListener("click", function () {
    ...
    cover.classList.remove("pass-through"); // <---
    btn.classList.remove("pushed");
